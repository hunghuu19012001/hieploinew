					...
					<div className="flex flex-col items-center justify-between lg:flex-row py-16">
							<div className=" relative ">
									...
									<div className="lg:max-w-xl lg:pr-5 relative z-40">
											<p className="flex text-sm text-gray-500 uppercase text-g1  ">
													
													GIỚI THIỆU
											</p>
											<h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
													Xe máy & Xe đạp điện uy tín
													<span className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">HIỆP LỢI</span>
											</h2>
											<p className="text-base text-gray-700">Chuyên xe máy và xe đạp điện chất lượng, giá tốt, dịch vụ tận tâm.
											</p>
											<div className="mt-10 flex flex-col items-center md:flex-row">
													<a href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
															Xem Thêm</a>
													<a href="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Liên hệ
